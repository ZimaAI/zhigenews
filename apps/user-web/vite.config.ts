...
export default defineConfig({
  ...
  server: { port: 5173, strictPort: true, proxy: { '/api': { target: apiTarget, changeOrigin: false } } },
  preview: { port: 5173, strictPort: true, proxy: { '/api': { target: apiTarget, changeOrigin: false } } },
});
