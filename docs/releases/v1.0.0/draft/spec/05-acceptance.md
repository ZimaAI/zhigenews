...
| AC-UI-002 | REQ-AUTH-001, REQ-UX-001 | frontend | 登录/注册有必填与格式校验、提交中、失败保留输入和退出；未完成首次偏好的用户进入单页引导，成功保存后进入今日，刷新/登录不重复引导，注册重新引导；原型不宣称真实鉴权。 |
...
| AC-UI-006 | REQ-BRIEF-001, REQ-UX-001 | frontend | 历史提供紧凑列表与必要搜索/筛选，无结果和分页可操作；详情保留内容版本和引用；返回保持筛选，不展示邮件状态或重复说明。 |
...
本轮 r3 保留 AC ID 并改写已被用户替代的旧规则：AC-UI-003/004 对应三字段偏好，AC-UI-007/008 与 AC-INT-001/002 对应每日站内发布；旧邮件、暂停和扩展偏好要求不再属于当前验收。Agent 长期记忆仍由 AC-BE-010 验证。
